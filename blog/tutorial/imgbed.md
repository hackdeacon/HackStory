...
![Fork](https://pic.hackstory.cn/blog/O3L0oKrr.png)

请注意新版本 Cloudflare 的 Workers and Pages 的仪表盘有所改动，请点击页面右上角的加号新建页面，而不是点击该页面上的创建应用程序。

![Cloudflare Pages](https://pic.hackstory.cn/blog/ss84IiGN.png)

连接你的 GitHub 账号后，选择我们刚刚 Fork 的仓库。

![导入 Git 仓库](https://pic.hackstory.cn/blog/o0wDMm5c.png)

构建命令填写 `npm install`，然后点击 `保存并部署`。

![构建命令](https://pic.hackstory.cn/blog/M41cp6fE.png)
...
![创建 R2](https://pic.hackstory.cn/blog/QIrt1hn6.png)
...
![创建 KV](https://pic.hackstory.cn/blog/qhGKv73R.png)
...
![绑定 R2](https://pic.hackstory.cn/blog/p71zLpeN.png)

继续添加 KV 命名空间，变量名 `img_url`。

![绑定 KV](https://pic.hackstory.cn/blog/wnDKNov3.png)

R2 和 KV 绑定完成之后，点击部署 -> **重试部署**。

![重新部署](https://pic.hackstory.cn/blog/EDfotoKI.png)
...
![自定义域名](https://pic.hackstory.cn/blog/lsUbpXNw.png)

**配置 R2 存储桶自定义域名**

例如 `r2.hackdeacon.com`，此处的自定义域名后面会用来作为 CDN 加速回源地址。

![R2 自定义域名](https://pic.hackstory.cn/blog/EY5SFUoL.png)
...
![TG](https://pic.hackstory.cn/blog/DllJ5ICR.png)
...
![默认 URL](https://pic.hackstory.cn/blog/b6UjgZvN.png)

## 六、防盗链

`Cloudflare 主页 -> Scrape Shield -> Hotlink 保护`

![防盗链](https://pic.hackstory.cn/blog/2XuTl8wG.png)
